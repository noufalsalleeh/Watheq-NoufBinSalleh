...
public interface CompanyRepository extends CrudRepository<Company, String>{
	...
	void updateStartDate(@Param("companyRefrence") String companyRefrence, @Param("startDate") Timestamp startDate);

	@Modifying 
	@Query ("UPDATE Company company SET company.endDate = :endDate WHERE company.companyRefrence = :companyRefrence")
	void updateEndDate(@Param("companyRefrence") String companyRefrence, @Param("endDate") Timestamp endDate);
